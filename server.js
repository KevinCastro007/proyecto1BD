...
var configuration = 
{
	...
	database: 'RegistroNotas'			//Base de Datos (BD)
}

//Importación de los módulos del servidor:
//periodo, profesor, estudiante, curso, grupo y miembro.
var fs = require('fs');
var routePath = __dirname + '/server_modules/';				//Especifcación de la carpeta: server_modules.
